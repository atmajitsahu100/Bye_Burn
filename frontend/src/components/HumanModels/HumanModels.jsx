  ...
  return (
    <>
        <div className=' w-full h-full bg-blue-50 flex flex-col justify-center items-center'>
            ...
            <div className=' w-7/12 h-full m-2 bg-blue-50 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 rounded-md p-2'>
                {
                    models.map( (model) => {
                        return (
            ...
            <div className='w-7/12 p-3 mb-4 flex justify-between'>
